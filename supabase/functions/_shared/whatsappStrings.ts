...
const BASE_STRINGS = {
  ...
  catKindergarten: { ar: "روضة أطفال", en: "kindergarten" },
  catUniversity: { ar: "جامعة", en: "university" },
  catCollege: { ar: "كلية", en: "college" },
  catLibrary: { ar: "مكتبة عامة", en: "library" },
  catDentist: { ar: "طبيب أسنان", en: "dentist" },
  catVeterinary: { ar: "طبيب بيطري", en: "vet" },
  catParking: { ar: "موقف سيارات", en: "parking" },
  catFastFood: { ar: "وجبات سريعة", en: "fast food" },
  catMarketplace: { ar: "سوق", en: "market" },
  catExchange: { ar: "صرافة", en: "currency exchange" },
  catTaxi: { ar: "تاكسي", en: "taxi" },
  catCinema: { ar: "سينما", en: "cinema" },
  catFireStation: { ar: "دفاع مدني", en: "fire station" },
  catCarWash: { ar: "غسيل سيارات", en: "car wash" },
  catMall: { ar: "مول", en: "mall" },
  catClothes: { ar: "ملابس", en: "clothes shop" },
  catMobilePhone: { ar: "محل هواتف", en: "phone shop" },
  catHairdresser: { ar: "حلاق", en: "hairdresser" },
  catCarRepair: { ar: "تصليح سيارات", en: "car repair" },
  catBookshop: { ar: "مكتبة كتب", en: "bookshop" },
  catOptician: { ar: "نظارات", en: "optician" },
  catLaundry: { ar: "مصبغة", en: "laundry" },
  catHotel: { ar: "فندق", en: "hotel" },
  catMuseum: { ar: "متحف", en: "museum" },
  catPark: { ar: "حديقة", en: "park" },
  catGym: { ar: "نادي رياضي", en: "gym" },
  catPlayground: { ar: "ملعب أطفال", en: "playground" },

  booksHeading: { ar: "كتب وجدتها لـ «{query}»:", en: "Books I found for “{query}”:" },
  booksInVisionex: { ar: "في مكتبة Visionex", en: "In the Visionex library" },
  booksFromOutside: { ar: "من مصادر خارجية (Open Library)", en: "From outside sources (Open Library)" },
  booksFreeRead: { ar: "مجاني للقراءة", en: "Free to read" },
