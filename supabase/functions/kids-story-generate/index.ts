...
// bytes rather than a provider URL. This function's contract returns a
// string usable directly as an <img src>, so a data: URI keeps that contract
// without adding a storage bucket this function never needed before.
