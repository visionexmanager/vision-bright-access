...
const notes: Record<string,Partial<GameReleaseInfo>> = {
  ...
  snake:{updatedAt:"2026-08-19",version:"2.0.0",howToPlay:["Steer with the arrow keys or WASD; a direct reversal is refused, never fatal.","Swipe on the board or use the on-screen direction pad on a touch screen.","Press B at any time for a spoken description of the whole board.","Eat thirty pieces of food to finish. Every five raises the level and the speed, and walls appear from level three."],changes:["Rebuilt on a seeded, fully tested engine so a round can be replayed from its seed.","Reversal into your own neck is now refused instead of ending the round.","Food is placed on a genuinely free cell instead of walking a fixed diagonal.","Levels, speed ramp, obstacle walls and a freshness scoring bonus.","Spoken board description, hazard warnings ahead of impact, and glyphs so no state is carried by colour alone.","Honours the shell pause instead of playing on behind the overlay."]},
