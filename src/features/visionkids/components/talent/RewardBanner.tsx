...
/** Generic "you earned a reward!" celebration banner — the Talent Hub's
 *  equivalent of Explorer's StampBanner, parameterized by message + amounts. */
              ...
              <p className="flex items-center gap-3 text-sm text-muted-foreground">
                {xp ? (
                  <span className="flex items-center gap-1">
                    <Sparkles className="h-3.5 w-3.5" aria-hidden="true" /> +{xp} {t("kids.talent.xp")}
                  </span>
                ) : null}
                {coins ? (
                  <span className="flex items-center gap-1">
