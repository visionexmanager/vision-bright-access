...
/** "You earned a reward!" celebration banner for the Health Hub. */
export function WellnessRewardBanner({
  show,
  message,
  xp,
  coins,
              ...
              <p className="flex items-center gap-3 text-sm text-muted-foreground">
                {xp ? (
                  <span className="flex items-center gap-1">
                    <Sparkles className="h-3.5 w-3.5" aria-hidden="true" /> +{xp} {t("kids.wellness.xp")}
                  </span>
                ) : null}
                {coins ? (
                  <span className="flex items-center gap-1">
