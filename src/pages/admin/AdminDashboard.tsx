...
import {
  ...
  Gamepad2, Store, Newspaper, GraduationCap, Library, Award, Landmark, LayoutDashboard, Trophy, BookOpen, Link2,
} from "lucide-react";
...
const ADMIN_CARDS = [
  ...
  { id: "socialConnections", key: null, icon: Link2, link: "/admin/social-connections", color: "text-sky-500" },
];
