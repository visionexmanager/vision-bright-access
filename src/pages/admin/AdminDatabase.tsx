...
export default function AdminDatabase() {
  ...
  return (
    <Layout><section className="mx-auto max-w-7xl px-4 py-10"><div className="mb-6 flex items-center gap-3"><Button asChild variant="ghost" size="icon"><Link to="/admin" aria-label="Back to admin"><ArrowLeft className="h-5 w-5" aria-hidden="true" /></Link></Button><h1 className="text-3xl font-bold">{t("admin.database.title")}</h1><Button variant="ghost" size="icon" onClick={loadTable} aria-label={t("admin.analytics.refresh")}><RefreshCw className="h-4 w-4" /></Button></div>
