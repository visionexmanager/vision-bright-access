...
import { RotateCcw, Trophy, Thermometer, Wind, Snowflake, Flame, ArrowLeft } from "lucide-react";
...
export function HvacSimulation({ simulationId }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      <SimulationScene slug="hvac-systems" isActive={installed} isComplete={finished} />
