...
import { CheckCircle2, XCircle, Wrench, Flame, Cpu, Battery, MemoryStick, Fan, Monitor, Zap, RotateCcw, Thermometer, AlertTriangle, ArrowLeft } from "lucide-react";
...
export function BoardSurgeonSimulation({ simulationId }: Props) {
  ...
  return (
    <div className="space-y-6">
      <SimulationScene slug="board-surgeon" isActive isComplete={false} />
      ...
      <SimulationMentor
        ...
        currentStepTitle={`Case ${caseIndex + 1} - ${stage}`}
      />
    </div>
  );
}
