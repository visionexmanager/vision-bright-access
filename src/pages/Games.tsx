...
export default function Games() {
  ...
  const games = useMemo(() => [
    ...
    { to: "/games/skybound-quest",    img: jungleImg,     title: lang === "ar" ? "مغامرة بوابة السماء" : "Skybound Quest", desc: lang === "ar" ? "مغامرة منصات أصلية مليئة بالقفز والكنوز والتحديات." : "An original platform adventure filled with jumps, treasures, and challenges.", badge: lang === "ar" ? "مغامرة آمنة" : "Safe adventure", category: "Action" as Category },
    { to: "/games/buildworld-kids",   img: dreamhomeImg,  title: lang === "ar" ? "عالم البناء للأطفال" : "BuildWorld Kids", desc: lang === "ar" ? "ابنِ عالمك الخاص بأمان، بلا دردشة أو محتوى من الغرباء." : "Build a private world safely, with no chat or content from strangers.", badge: lang === "ar" ? "آمنة للأطفال" : "Kid-safe", category: "Creative" as Category },
    { to: "/games/knowledge-galaxy", img: quizImg,       title: lang === "ar" ? "مجرة المعرفة" : "Knowledge Galaxy", desc: lang === "ar" ? "تعلم العلوم والرياضيات واللغة والجغرافيا من خلال اللعب." : "Learn science, math, language, and geography through play.", badge: lang === "ar" ? "تعليمية" : "Educational", category: "Brain" as Category },
