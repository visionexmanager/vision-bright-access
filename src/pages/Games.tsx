...
export default function Games() {
  ...
  const games = [
    { to: "/games/quiz-challenge", icon: <Gamepad2 className="h-8 w-8 text-primary" aria-hidden="true" />, badge: t("games.quiz.badge"), title: t("games.quiz.title"), desc: t("games.quiz.desc"), info: t("games.quiz.info"), img: quizImg },
    { to: "/games/memory", icon: <Grid3X3 className="h-8 w-8 text-primary" aria-hidden="true" />, badge: t("games.memory.badge"), title: t("games.memory.title"), desc: t("games.memory.desc"), info: t("games.memory.info"), img: memoryImg },
    { to: "/games/word-puzzle", icon: <Type className="h-8 w-8 text-primary" aria-hidden="true" />, badge: t("games.word.badge"), title: t("games.word.title"), desc: t("games.word.desc"), info: t("games.word.info"), img: wordImg },
  ];
              ...
              <Link to={game.to} className="group" onClick={() => playSound("start")}>
                <Card className="h-full overflow-hidden transition-shadow hover:shadow-lg">
                  <div className="relative h-40 w-full overflow-hidden">
                    <img src={game.img} alt="" className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" width={640} height={512} loading="lazy" />
