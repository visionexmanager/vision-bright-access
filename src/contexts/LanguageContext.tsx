...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "content.subtitle": "Learn about accessibility — earn points for reading and completing content.",
    ...
    "content.a4": "Screen Reader Compatibility",
    "content.a5": "Inclusive Design Principles",
    "content.a6": "ARIA Labels Done Right",
